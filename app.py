...
class MedicalDiagnosisSystem(QMainWindow):
    ...
    def load_model_and_data(self):
        ...
        try:
            ...
            self.precautions = pd.read_csv("./archive/precautions_df.csv")
            self.workout = pd.read_csv("./archive/workout_df.csv")
            self.description = pd.read_csv("./archive/description.csv")
            self.medications = pd.read_csv("./archive/medications.csv")
            self.diets = pd.read_csv("./archive/diets.csv")
